...
async def create_provider(payload: ProviderCreate, session: DbSession) -> dict[str, Any]:
    ...
    profile = ProviderProfile(
        ...
        cached_input_price_per_million_usd=payload.cached_input_price_per_million_usd,
...
def serialize_provider(profile: ProviderProfile, configured: bool) -> dict[str, Any]:
    return {
        ...
        "cached_input_price_per_million_usd": profile.cached_input_price_per_million_usd,
